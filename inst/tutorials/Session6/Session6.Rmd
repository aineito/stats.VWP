...
We will ad the model fit with a new name `mfit_linear`.  
```{r eval=T, echo=T, message=F}
...
We can use `anova()` function to compare two (or more) models.  
```{r eval=T, echo=T, message=F}
...
Once you get the results from the best model, you can to write a summary of the findings.  
