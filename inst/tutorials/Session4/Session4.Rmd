...
- **Log-likelihood** is also used to assess the fir of the model. Again, the smaller the value, the better the model fit.  
...
Again, make sure that both `Subject` and `Item` are treated as a factor.  
